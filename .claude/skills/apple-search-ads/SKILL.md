...
Use MCP-GC's keyword tools to validate volume and difficulty:
```
mcp__aso-keyword__get_keyword_volume(keywords=["meditation app","mindfulness","sleep sounds"], country="us")
mcp__aso-keyword__search_keywords(term="meditation", country="us")
```
