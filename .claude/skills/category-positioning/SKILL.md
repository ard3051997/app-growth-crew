...
| **Average #1 downloads** — Roughly how many DLs/day to be #1? | No free estimator for this — approximate qualitatively from category churn observed via weekly `mcp__aso-keyword__get_category_top_apps` snapshots (see [mcp-gc.md](../aso-tools/integrations/mcp-gc.md) gaps) |
