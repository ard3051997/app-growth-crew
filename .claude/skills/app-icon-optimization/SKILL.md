...
- **Significance threshold:** p < 0.05, or use `mcp__play-store__create_store_listing_experiment`'s built-in confidence indicator for a live Play Store experiment
