...
class Review(BaseModel):
    ...
    android_version: str | int | None = Field(None, description="Android OS version")
...
class InAppProduct(BaseModel):
    ...
    prices: dict[str, Any] | None = Field(None, description="Full regional pricing by country code")
